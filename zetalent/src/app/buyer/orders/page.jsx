    ...
    <div className="min-h-[80vh] my-10 mt-0 px-32">
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-[#8cbfca] dark:text-[#000000]">
            <tr>
          ...
          <tbody>
            {orders.map((order) => {
              return (
                <tr
                  className="bg-white dark:bg-[#435c5a] hover:bg-gray-50 hover:dark:text-[#557880]"
                  key={order.id}
                >
